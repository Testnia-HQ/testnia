...
const HERO_IMAGE = 'https://images.hostinger.com/eb83b60d-108b-4fb0-a148-eeab3c95511b.png';
        ...
        <div className="min-h-screen bg-background text-foreground">
                ...
                <div className="relative mx-auto grid max-w-[80rem] items-center gap-12 px-5 py-16 md:grid-cols-[1.05fr_0.95fr] md:py-24">
                    <div>
                        ...
                        <div className="mt-9 flex flex-wrap items-center gap-3">
                            <Link
                                to="/signup"
                                className="inline-flex min-h-[48px] items-center gap-2 rounded-full bg-primary px-6 text-sm font-semibold text-primary-foreground transition active:scale-[0.98]"
                            >
                                {t('home.ctaCreate')} <ArrowRight className="h-4 w-4" />
                            </Link>
                            <a
                                href="#exams"
                                className="inline-flex min-h-[48px] items-center rounded-full border border-border px-6 text-sm font-semibold transition hover:border-primary hover:text-primary"
                            >
                                {t('home.ctaBrowse')}
                            </a>
                        </div>
            ...
            <section id="exams" className="mx-auto max-w-[72rem] px-5 py-20">
                ...
                <div className="mt-10 divide-y divide-border border-y border-border">
                    {state === 'loading' &&
                        [0, 1, 2].map((i) => (
                            <div key={i} className="flex animate-pulse items-center gap-6 py-6">
                    ...
                    <div id="how" className="grid gap-4 sm:grid-cols-2">
                        {PILLARS.map((p, i) => (
                            <Reveal key={p.titleKey} delay={i * 0.07}>
                                <div className="h-full rounded-2xl border border-border bg-background p-5 transition hover:-translate-y-0.5 hover:border-primary/40">
